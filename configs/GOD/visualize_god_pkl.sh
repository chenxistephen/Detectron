...
MODEL_NAME=retr50_bs_2-iter_1600000-lr_0.01
MODEL_PATH=/media/data/chnxi/GOD/Models/$MODEL_NAME/Test_400
...
# python tools/visualize_results.py --dataset $TESTSET --thresh 0.5 --detections $MODEL_PATH/$TESTSET/retinanet/detections.pkl --output-dir $MODEL_PATH/visualizations/$TESTSET/ --sampleNum 1000 --class_list_file /media/data/chnxi/GOD/taxonomy/GOD_V1_labels.txt
